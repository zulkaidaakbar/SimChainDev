...
TH1D *h_dreco_x_st1 = new TH1D("h_dreco_x_st1", "h_dreco_x_st1", 60,-1.5,1.5);
h_dreco_x_st1->Sumw2();

TH1D *h_dtracklet_x_st1 = new TH1D("h_dtracklet_x_st1", "h_dtracklet_x_st1", 50,-5,5);
h_dtracklet_x_st1->Sumw2();

TH1D *h_dreco_y_st1 = new TH1D("h_dreco_y_st1", "h_dreco_y_st1", 60,-1.5,1.5);
h_dreco_y_st1->Sumw2();

TH1D *h_dtracklet_y_st1 = new TH1D("h_dtracklet_y_st1", "h_dtracklet_y_st1", 60,-1.5,1.5);
   ...
   for (int i=0; i<n_tracks; i++)
    {
     ...
     double tracklet_x_st1 = tracklet_x0[i] + tracklet_tx[i]*617.274; //position of the D0X
