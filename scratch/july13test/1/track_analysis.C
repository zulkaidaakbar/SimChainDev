...
gStyle->SetOptFit(1);
bool draw=false; //drawing option
bool KFREF=false;
bool DAFREF=false;
bool Test_file=true;
   ...
   for (int i=0; i<n_tracks; i++)
    {
     ...
     if (Test_file)
      {
       cerr<<covSt1_0[i]<<"   "<<covar_matrix[i][0][0]<<endl;
      }
